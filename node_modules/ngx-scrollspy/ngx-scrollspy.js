import { ChangeDetectionStrategy, ChangeDetectorRef, Component, Directive, ElementRef, EventEmitter, Injectable, Input, NgModule, Output, Renderer2 } from '@angular/core';
...
class ScrollSpyAffixDirective {
    /**
     * @param {?} ref
     * @param {?} elRef
     * @param {?} scrollSpy
     */
    constructor(ref, elRef, scrollSpy) {
        this.ref = ref;
        this.elRef = elRef;
        this.scrollSpy = scrollSpy;
        this.affix = false;
    ...
    ngAfterViewInit() {
        ...
        if (!!this.scrollSpy.getObservable('window')) {
            ...
            this.scrollStream$ = this.scrollSpy.getObservable('window').subscribe((e) => {
...
class ScrollSpyIndexDirective {
    /**
     * @param {?} elRef
     * @param {?} scrollSpyIndex
     */
    constructor(elRef, scrollSpyIndex) {
        this.elRef = elRef;
...
class ScrollSpyIndexRenderComponent {
    /**
     * @param {?} ref
     * @param {?} elRef
     * @param {?} scrollSpy
     * @param {?} scrollSpyIndex
     */
    constructor(ref, elRef, scrollSpy, scrollSpyIndex) {
        this.ref = ref;
        this.elRef = elRef;
        this.scrollSpy = scrollSpy;
        this.scrollSpyIndex = scrollSpyIndex;
    ...
    ngOnInit() {
        ...
        this.changeStream$ = this.scrollSpyIndex.changes$.subscribe((e) => {
    ...
    ngAfterViewInit() {
        if (!!this.scrollSpy.getObservable(this.scrollSpyIndexRenderOptions.spyId)) {
            this.scrollStream$ = this.scrollSpy.getObservable(this.scrollSpyIndexRenderOptions.spyId).subscribe((e) => {
                if (typeof e.target.scrollingElement !== 'undefined') {
     ...
     */
    update() {
        const /** @type {?} */ data = this.scrollSpyIndex.getIndex(this.scrollSpyIndexRenderOptions.id) || [];
        let /** @type {?} */ stack = [];
        let /** @type {?} */ parentStack = [];
        let /** @type {?} */ lastItem;
        this.items = [];
        this.itemsHash = {};
        for (var /** @type {?} */ i = 0; i < data.length; ++i) {
            ...
            if (parentStack.length > 0) {
                ...
                let /** @type {?} */ temp = this.items;
                for (var /** @type {?} */ t = 0; t < parentStack.length; ++t) {
                    if (t < parentStack.length - 1) {
                        temp = temp.filter((e) => { return e.link === parentStack[t]; })[0].children;
                    }
                    else {
                        temp.filter((e) => { return e.link === parentStack[t]; })[0].children.push(item);
                    }
                }
            }
            else {
     ...
     */
    calculateHighlight() {
        var /** @type {?} */ items = this.scrollSpyIndex.getIndex(this.scrollSpyIndexRenderOptions.id);
        this.itemsToHighlight = [];
        if (!items || !items.length) {
            return;
        }
        var /** @type {?} */ highlightItem;
...
class ScrollSpyInfiniteDirective {
    /**
     * @param {?} scrollSpy
     */
    constructor(scrollSpy) {
    ...
    ngAfterViewInit() {
        if (!!this.scrollSpy.getObservable(this.options.spyId)) {
            this.scrollStream$ = this.scrollSpy.getObservable(this.options.spyId).pipe(throttleTime(200)).subscribe((e) => {
...
class ScrollSpyParallaxDirective {
    /**
     * @param {?} renderer
     * @param {?} elRef
     * @param {?} scrollSpy
     */
    constructor(renderer, elRef, scrollSpy) {
    ...
    ngAfterViewInit() {
        if (!!this.scrollSpy.getObservable(this.options.spyId)) {
            this.scrollStream$ = this.scrollSpy.getObservable(this.options.spyId).subscribe((e) => {
     ...
     */
    evaluateScroll(target) {
        let /** @type {?} */ currentScrollPosition;
...
export { ScrollSpyModule, ScrollSpyService, ScrollSpyDirective, ScrollSpyElementDirective, ScrollSpyAffixModule, ScrollSpyAffixDirective, ScrollSpyIndexModule, ScrollSpyIndexService, ScrollSpyIndexDirective, ScrollSpyIndexRenderComponent, ScrollSpyInfiniteModule, ScrollSpyInfiniteDirective, ScrollSpyParallaxModule, ScrollSpyParallaxDirective };
//# sourceMappingURL=ngx-scrollspy.js.map
